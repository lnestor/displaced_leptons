...
def calculate(l1, l2, max_iterations=5):
    ...
    for i in range(max_iterations):
        ...
        res1 = r2 * (cos2 * (a - r1 * sin1) + sin2 * (b + r1 * cos1) + c1 * (phi2 - phi2_0) + d1 * (phi1 - phi1_0) + tan2 * dz)
        res2 = -r1 * (cos1 * (a + r2 * sin2) + sin1 * (b - r2 * cos2) + c2 * (phi1 - phi1_0) + d2 * (phi2 - phi2_0) + tan1 * dz)
