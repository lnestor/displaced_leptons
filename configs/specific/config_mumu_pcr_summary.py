...
cfg = Configurator(
    ...
    datasets = {
        ...
        "filter": {
            "samples": ["Muon", "DY", "Diboson", "SingleTop", "TTbar", "QCDEle", "QCDMu"],
    ...
    categories = {
        **get_pcr_cat(channel="mumu", field="absd0_um", threshold=50)
    },
    hists = {
        **pcr_hists(coll="MuonGood", pos=0, label="LeadingMuon"),
        **pcr_hists(coll="MuonGood", pos=1, label="SubleadingMuon"),
